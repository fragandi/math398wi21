...
-- This step feels kind of artificial and I'd like to find some way to make it so we don't have to manually add these elements.
i = 1
while (i <= 3) do (
    M = M | {(modBy#i)^(d#0)};
    i = i + 1;
